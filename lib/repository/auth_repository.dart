...
final authRepositoryProvider = Provider(
  (ref) => AuthRepository(
    googleSignIn: GoogleSignIn(), client: Client(), localStorageRepository: LocalStorageRepository(),
  ),
);
...
class AuthRepository {
  ...
  AuthRepository({
    ...
    required Client client, required LocalStorageRepository localStorageRepository,
    ...
    try {
      ...
      if(user!=null) {
        ...
        switch(res.statusCode) {
          case 200: final newUser = userAcc.copyWith(
